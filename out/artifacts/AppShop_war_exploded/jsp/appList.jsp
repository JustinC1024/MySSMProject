        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <form action="/user/search">
                    <div class="col-md-4">
                        <input  class="col-md-3" type="text" name="name" class="form-control"/>
                        <div class="col-md-1"></div>
                        <input type="submit" value="查询" class="btn btn-success col-md-2" >
                    </div>
                    <div class="col-md-4">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div style="float: right">
                    ...
                    <c:if test="${sessionScope.pages.now!=1}">
                        <a href="/user/index/1">首页</a>
                        <a href="/user/index/${sessionScope.pages.now-1}">上一页</a>
                    </c:if>
                    <span>${sessionScope.pages.now}<span>/</span>${sessionScope.pages.num}</span>
                    <c:if test="${sessionScope.pages.now!=sessionScope.pages.total}">
                        <a href="/user/index/${sessionScope.pages.now+1}">下一页</a>
                        <a href="/user/index/${sessionScope.pages.num}">尾页</a>
                    </c:if>
                    </P>
                </div>
            </div>
