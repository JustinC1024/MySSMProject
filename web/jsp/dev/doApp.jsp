                        ...
                        <form class="form-horizontal form-label-left" name="goto" action="" method="post">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input class="form-control col-md-7 col-xs-12" type="text" required="required" name="aiName">
                                </div>
                            </div>
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">APK ：<span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" class="form-control col-md-7 col-xs-12" required="required" name="APKName">
                                </div>
                            </div>
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">ROM ：<span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" class="form-control col-md-7 col-xs-12" required="required" name="supportROM">
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" class="form-control col-md-7 col-xs-12" required="required" name="interfaceLanguage">
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" class="form-control col-md-7 col-xs-12" required="required" name="appSize">
                                </div>
                            </div>
                            <div class="item form-group">
                                    ...
                                    <select id="at1" class="form-control col-md-2 col-xs-12">
                                        ...
                                        <c:forEach items="${sessionScope.appType}" var="list">
                                            <c:if test="${list.parentId==0}">
                                                <option value="${list.id}"> ${list.atName}</option>
                                            </c:if>
                                        </c:forEach>
                                    </select>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <textarea class="form-control col-md-7 col-xs-12" required="required" name="appInfo"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-3" style="text-align: center">
                                    ...
                                    <button type="button" class="btn btn-success" onclick="cancle()">取消</button>
                                </div>
                            </div>
                        </form>
                        <script>
                            function up() {
                                document.goto.action="/developer/doApp";
                                goto.submit();
                            }
                            function cancle() {
